...
<div class="alert alert-success" role="alert">
        <i class="fas fa-university"></i> Form Masuk Halaman Rapor
    </div>
    <?php echo $this->session->flashdata('pesan') ?>

    <form method="post" action="<?php echo base_url('administrator/rapor/rapor_aksi')?>">
        <div class="form-group">
            <label>Nama Siswa</label>
            <input type="text" name="siswa" placeholder="Masukan Nama Siswa" class="form-control">
            <?php echo form_error('siswa','<div class="text-danger small ml-2">','</div>')   ?>
        </div>
