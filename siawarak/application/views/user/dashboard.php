...
<div class="alert alert-success" role="alert">
  ...
  <p>Selamat Datang <strong><?php echo $username; ?></strong> di Sistem Informasi Akademik SD Negeri Siwarak Wetan, Anda Login sebagai <strong><?php echo $level; ?></strong> </p>
  <hr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <div class="col md-3 text-info text-center">
                <a href="<?php echo base_url() ?>"><p class="nav-link small text-info">MATA PELAJARAN</p></a>
        ...
        <div class="row">
            ...
            <div class="col md-3 text-info text-center">
                <a href="<?php echo base_url() ?>"><p class="nav-link small text-info">ROMBONGAN BELAJAR</p></a>
